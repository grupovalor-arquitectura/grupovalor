...
export default function FooterStatic() {
  return (
    ...
    >
      ...
      >
        <Typography sx={{ fontWeight: 400, fontSize: 25,  mb: 0, lineHeight: 1.2, }}>valor</Typography>
        <Typography sx={{ fontWeight: 400, fontSize: 25,  mb: 0, lineHeight: 1.2, }}>más allá</Typography>
        <Typography sx={{ fontWeight: 400, fontSize: 25,  mb: 0, lineHeight: 1.2, }}>del espacio</Typography>
      </Box>
    </Box>
  );
}